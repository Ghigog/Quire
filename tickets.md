...
| QUI-028 | Encoder vs SLM for quotation attribution | Spike | In progress | exciting-cray | — |
...
> **Claimed 2026-09-08 for the SLM half.** The encoder half is closed (ADR-0005). What's
> left is fixing the Explicit-quotation sub-score on the scene-level SLM predictor before
> any other number from it can be trusted — see the 2026-09-08 Worklog entry and
> `docs/handoff/2026-09-08-attribution-state-of-play.md` §4.

**Status:** In progress · **Owner:** exciting-cray · **Epic:** Spike · **Depends on:** —
