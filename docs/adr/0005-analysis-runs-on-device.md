# ADR-0005 — Book analysis runs on-device

**Status:** Accepted, 2026-09-02
**Date:** 2026-09-02
**Ticket:** QUI-032 (what prompted it), QUI-031 (what it commits us to)
**Deciders:** dylangrowcoot, session-visibility-check

## Context

Deterministic attribution has a ceiling and we have now measured where it is. QUI-032 scored
